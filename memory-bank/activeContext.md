...
dev:     893d468 (7.1.20)
ai-base: f1a0bad (7.1.20)
```

---

**master 历史重构 (2026-03-31 01:20)**

---

**多分支同步与版本回退 (2026-03-31 01:10)**

---

**ai-base → dev 文件同步 (2026-03-31 00:38)**

---

## 📋 之前变更

**同步**: 从 ai-base 分支同步 `makefile` 和 `src/window_manager.c` 到 dev 分支

**提交**: `1bdb33d` + `cc825e1` on dev
